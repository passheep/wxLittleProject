...
__DEFINE__(1578386726494, function(require, module, exports) {
...
}, function(modId) {var map = {"./listeners":1578386726495,"./life-cycle":1578386726496}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1578386726495, function(require, module, exports) {
...
__DEFINE__(1578386726496, function(require, module, exports) {
...
}, function(modId) { var map = {"./configuration":1578386726497,"./listeners":1578386726495}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1578386726497, function(require, module, exports) {
...
function mergeConfig(customize, defaults) {
    var config = __assign(__assign({}, defaults), customize);
    if (defaults.headers && customize.headers) {
        // 合并headers
        config.headers = __assign(__assign({}, defaults.headers), customize.headers);
    }
    return config;
}
...
return __REQUIRE__(1578386726494);
})()
//# sourceMappingURL=index.js.map