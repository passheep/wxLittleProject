...
declare type KeyBasicValuePair = Record<string, string | number | boolean | null | undefined>;
declare type PromiseOrValue<T> = T | PromiseLike<T>;
...
export declare type SuccessParam<T extends WxOptions> = Parameters<NonNullable<T['success']>>[0];
/**
 * 所有网络请求的集成类型,可全局配置
 */
export interface BaseConfiguration<TFullOptions extends BaseConfiguration<TFullOptions, TWxOptions>, //完整配置
...
TRetrun = any> {
     ...
     */
    transformSend(options: TFullOptions): PromiseOrValue<Omit<TWxOptions, 'complete' | 'success' | 'fail'>>;
    /**
 ...
 * @param defaults 默认值
 */
export declare function mergeConfig<T1 extends Partial<T2>, T2 extends {
    [key: string]: any;
